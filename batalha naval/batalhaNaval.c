...
tabuleiro [7][j] = 4;
   ...
   tabuleiro [5][8] = 5;
    ...
    printf("POSICIONAMENTO DO NAVIO HORIZONTAL REPRESENTANDO NUMERO 3");
    printf("\n");

    printf("POSICIONAMENTO DO NAVIO VERTICAL REPRESENTANDO NUMERO 3");
    printf("\n");

    printf("POSICIONAMENTO DO NAVIO DIAGONAL PRIMARIA É SEGUNDARIA REPRESENTANDO NUMERO 2");
    printf("\n");

    printf("POSICIONAMENTO DO NAVIO CONE REPRESENTANDO NUMERO 7");
    printf("\n");

    printf("POSICIONAMENTO DO NAVIO CRUZ REPRESENTADO NUMERO 4");
    printf("\n");
    
    printf("POSICIONAMENTO DO NAVIO OCTAEDRO REPRESENTANDO NUMERO 5");
    printf("\n");
